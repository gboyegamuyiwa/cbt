...
$query = mysqli_query($link, "SELECT username, fullname, grade, subject_name, score, date_taken FROM results;");
?>
...
<html lang="en">
  ...
  <script src="js/jquery-3.6.0.js"></script>
    ...
    <div class="container">
    <center><h2>Students' Results</h2></center><br>
		        <?php 
            if(isset($_GET['msg'])){
            if ($_GET['msg'] === "success"){
              echo "<div class='alert alert-success' role='alert'>Reset Successful!</div>";
            }
            else{
              echo "<div class='alert alert-danger' role='alert'>Reset Not Successful!</div>";
            }
          } ?>
        ...
        <table id="viewResult" class="table display table-bordered table-striped" style="width:100%;text-transform:uppercase;font-family:Ubuntu;">
          ...
          <tbody>
                  ...
                  while ( $view = mysqli_fetch_assoc($query) ) {
                    ...
                    echo "<td>" . $view['subject_name'] . "</td>";
                    echo "<td>" . $view['score'] . "</td>";
                    echo "<td>" . $view['date_taken'] . "</td>";
                    echo "<td> <a href=\"delete_results.php?id=$view[subject_name]\" class=\"btn btn-danger\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                    echo "</tr>";
                  }
                  ?>
          </tbody>
