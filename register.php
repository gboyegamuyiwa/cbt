...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Validate grade
    if($_POST['grade'] == ""){
        $grade_err = "Please choose a Class.";     
    } else{
...
<html lang="en">
  ...
  <section class="container">
      <div class="row">
        <div class="left-column col-lg-5 text-center justify-center">
          <div class="img-left">
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <select class="custom-select w-80 <?php echo (!empty($grade_err)) ? 'is-invalid' : ''; ?>" name="grade">
